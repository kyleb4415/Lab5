...
namespace Lab5MusicAPI
{
    public class Program
    {
        ...
        static async Task Main(string[] args)
        {
            ...
            Console.Write("Enter an artist you'd like to look up:");
            await ArtistCall(Console.ReadLine());
            Console.WriteLine("\n\nEnter what song you'd like to find: ");
            await FindSong(Console.ReadLine());
            //await EventCall("something");
            //await GenreCall("doggy");
            //await PlayMP3();
            //await FindSong();
        }
        ...
        public static async Task EventCall(string EventName)
        {
            ...
            Console.WriteLine($"Here's the stuff: {eventStuff.ToString()}");
            Console.WriteLine($"More stuff: {json}");
        ...
        public static async Task PlayMusicFile(string filePath)
        {
            ...
            Console.WriteLine("Press enter to stop and go back to the menu.");
            Console.ReadLine();
            player.Stop();
        }
    }
